...
for i in $(seq 20); do
    ...
    docker run --rm openjdk:8u212 \
        "curl -sO https://repo1.maven.org/maven2/org/broadinstitute/gatk/4.1.2.0/gatk-4.1.2.0.pom.md5;curl -sO https://git.drupalcode.org/project/drupal/raw/8.7.0/sites/default/default.services.yml;curl -sO https://git.drupalcode.org/project/drupal/raw/8.7.0/update.php;curl -sO https://raw.githubusercontent.com/drupal/drupal/8.7.0/index.php;curl -sO https://raw.githubusercontent.com/drupal/drupal/8.7.0/sites/example.sites.php"
    echo
